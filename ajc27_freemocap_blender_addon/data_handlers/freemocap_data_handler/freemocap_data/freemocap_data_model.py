...
from ajc27_freemocap_blender_addon.data_handlers.component_data import ComponentData
...
class FreemocapData:
    ...
    other: Dict[str, ComponentData] = field(default_factory=dict)
    ...
    @classmethod
    def _convert_to_component(cls, other: Dict[str, Union[ComponentData, Dict[str, Any]]]):
    ...
    def from_data_paths(cls,
        ...
        return cls.from_data(
            ...
            other={"center_of_mass": ComponentData(name="center_of_mass",
                                                   data=np.load(
