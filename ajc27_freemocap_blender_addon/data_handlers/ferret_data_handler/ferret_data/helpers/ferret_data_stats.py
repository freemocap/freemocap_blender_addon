...
class FerretDataStats:
    ...
    @classmethod
    def from_ferret_data(cls, ferret_data:FerretData):
        return cls(
            body_stats=calculate_stats(ferret_data.body.data),
            right_hand_stats=calculate_stats(ferret_data.hands['right'].data),
            left_hand_stats=calculate_stats(ferret_data.hands['left'].data),
            face_stats=calculate_stats(ferret_data.face.data),
        )
