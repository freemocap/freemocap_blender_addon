from freemocap_blender_addon.core_functions.export_3d_model.helpers import set_armature_pose_by_markers
import bpy
import numpy as np
import math as m
...
def limit_markers_range_of_motion(
    data_parent_empty: bpy.types.Object,
    start_frame: int,
    end_frame: int,
    target_categories: list[str] = ['proximal_phalanx', 'intermediate_phalanx', 'distal_phalanx'],
    range_of_motion_scale: float = 1.0,
    hand_locked_track_marker_name: str = 'hand_index_finger_mcp',
    hand_damped_track_marker_name: str = 'hand_middle_finger_mcp',
):
