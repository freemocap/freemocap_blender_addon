...
from freemocap_blender_addon.utilities.type_safe_dataclass import TypeSafeDataclass, TypeHintError, enforce_type_hints
...
def test_inherited_data_class():
    ...
    """
    instance = InheritedDataClass(number=1, text="test", data_list=[1, 2, 3], data_dict={"key": 1}, extra_inherited_field=1.0)
    enforce_type_hints(instance)
