...
from skelly_blender.core.freemocap_data.data_paths.default_path_enums import PathPlaceholders, RightLeft, \
    SkeletonNpyFiles, CenterOfMassNpyFiles, VideoFolders
from skelly_blender.core.freemocap_data.data_paths.numpy_paths import SkeletonNpyPaths, \
    CenterOfMassNpyPaths, \
    HandsNpyPaths
from skelly_blender.core.freemocap_data.data_paths.video_paths import FreemocapVideoPaths, VideoFolder
