...
from skelly_blender.core.skeleton_model.abstract_base_classes.base_enums import LinkageEnum, SegmentEnum, \
    KeypointEnum
from skelly_blender.core.skeleton_model.abstract_base_classes.segments_abc import SegmentABC
