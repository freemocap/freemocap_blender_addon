from skelly_blender.core.skeleton_model.abstract_base_classes.base_enums import KeypointMappingsEnum
...
_MEDIAPIPE_BODY_MAPPING = {
    ...
    bk.PELVIS_LUMBAR_RIGHT_HIP_ACETABULUM.name: [mbp.RIGHT_HIP.lower()],
    ...
    bk.PELVIS_LUMBAR_LEFT_HIP_ACETABULUM.name: [mbp.LEFT_HIP.lower()],
