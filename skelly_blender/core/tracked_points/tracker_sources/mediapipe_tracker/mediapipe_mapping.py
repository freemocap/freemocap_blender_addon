from skelly_blender.core.skeleton_model.abstract_base_classes.keypoint_mapping_abc import KeypointMappingsEnum
from skelly_blender.core.skeleton_model.static_definitions.body.body_keypoints import BodyKeypoints as bk
...
_MEDIAPIPE_BODY_MAPPING = {
    bk.SKULL_FORWARD_NOSE_TIP.name: [mbp.NOSE.lower()],
    bk.RIGHT_SKULL_EYE_INNER.name: [mbp.RIGHT_EYE_INNER.lower()],
    bk.RIGHT_SKULL_EYE_CENTER.name: [mbp.RIGHT_EYE.lower()],
    bk.RIGHT_SKULL_EYE_OUTER.name: [mbp.RIGHT_EYE_OUTER.lower()],
    bk.RIGHT_SKULL_ACOUSTIC_MEATUS.name: [mbp.RIGHT_EAR.lower()],
    bk.RIGHT_SKULL_CANINE_TOOTH_TIP.name: [mbp.MOUTH_RIGHT.lower()],
    bk.LEFT_SKULL_EYE_INNER.name: [mbp.LEFT_EYE_INNER.lower()],
    bk.LEFT_SKULL_EYE_CENTER.name: [mbp.LEFT_EYE.lower()],
    bk.LEFT_SKULL_EYE_OUTER.name: [mbp.LEFT_EYE_OUTER.lower()],
    bk.LEFT_SKULL_ACOUSTIC_MEATUS.name: [mbp.LEFT_EAR.lower()],
    bk.LEFT_SKULL_CANINE_TOOTH_TIP.name: [mbp.MOUTH_LEFT.lower()],
    bk.SKULL_ORIGIN_FORAMEN_MAGNUM.name: [mbp.LEFT_EAR.lower(),
                                          mbp.RIGHT_EAR.lower()],
    bk.CERVICAL_SPINE_TOP_C1_AXIS.name: {mbp.LEFT_EAR.lower(): .45,
                                         mbp.RIGHT_EAR.lower(): .45,
                                         mbp.LEFT_SHOULDER.lower(): .05,
                                         mbp.RIGHT_SHOULDER.lower(): .05},
    bk.CERVICAL_SPINE_ORIGIN_C7.name: {mbp.LEFT_EAR.lower(): .4,
                                       mbp.RIGHT_EAR.lower(): .4,
                                       mbp.LEFT_SHOULDER.lower(): .1,
                                       mbp.RIGHT_SHOULDER.lower(): .1},
    bk.THORACIC_SPINE_TOP_T1.name: [mbp.LEFT_SHOULDER.lower(),
                                    mbp.RIGHT_SHOULDER.lower()],
    bk.THORACIC_SPINE_ORIGIN_T12.name: [mbp.LEFT_HIP.lower(),
                                        mbp.RIGHT_HIP.lower(),
    ...
    bk.PELVIS_ORIGIN.name: [mbp.LEFT_HIP.lower(),
                            mbp.RIGHT_HIP.lower()],
    ...
    bk.RIGHT_PELVIS_HIP_ACETABULUM.name: [mbp.RIGHT_HIP.lower()],
    ...
    bk.LEFT_CLAVICLE.name: {mbp.LEFT_SHOULDER.lower(): .55,
                            mbp.RIGHT_SHOULDER.lower(): .45},
    ...
    bk.LEFT_PELVIS_HIP_ACETABULUM.name: [mbp.LEFT_HIP.lower()],
