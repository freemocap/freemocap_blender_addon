...
def load_skelly_fbx_meshes() -> Dict[str, bpy.types.Object]:
    meshes = {}
    base_bone_mesh_folder_path = Path(SKELLY_BONE_MESHES_PATH)
    for bone_mesh_segment_host, subfolder_path in SKELLY_BONE_MESHES.items():
        if not subfolder_path:
            continue
        mesh_path = base_bone_mesh_folder_path / subfolder_path
