...
from skelly_blender.core.needs_bpy.meshes.rigid_body_meshes.create_material import create_material
...
def make_rigid_body_mesh(name: str = "bone_mesh",
    ...
    cone = make_cone_mesh(color=cone_color)

    joint_sphere = make_joint_sphere_mesh(color=joint_color)
