...
from skellyblender.core.pure_python.custom_types.derived_types import Trajectories
from skellyblender.core.pure_python.freemocap_data.transform_skeleton_data.get_low_velocity_frame import \
    get_low_velocity_frame
from skellyblender.core.pure_python.freemocap_data.transform_skeleton_data.points_transformers import transform_points
from skellyblender.core.pure_python.skeleton_model.static_definitions.body.body_keypoints import BodyKeypoints
from skellyblender.core.pure_python.math_stuff.orthonormal_basis_3d import OrthonormalBasis3D
...
def put_skeleton_on_ground(keypoint_trajectories: Trajectories, copy_trajectories: bool = False) -> Trajectories:
    ...
    original_reference_locations = {trajectory_name: trajectory.trajectory_fr_xyz[good_frame, :]
    ...
    z_up_reference = keypoint_trajectories[
                         BodyKeypoints.SKULL_ORIGIN_FORAMEN_MAGNUM.name.lower()].trajectory_fr_xyz[
                     good_frame, :]
    ...
    for key in transformed_trajectories.keys():
        transformed_trajectories[key].trajectory_fr_xyz = transform_points(
            points=keypoint_trajectories[key].trajectory_fr_xyz,
