from skellyblender.core.pure_python.custom_types.base_enums import KeypointMappingsEnum
from skellyblender.core.pure_python.skeleton_model.static_definitions.body.body_keypoints import BodyKeypoints as bk
from skellyblender.core.pure_python.tracked_points.tracker_sources.mediapipe_tracker.mediapipe_point_names import \
