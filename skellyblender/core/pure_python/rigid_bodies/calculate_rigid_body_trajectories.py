...
from skellyblender.core.pure_python.custom_types.derived_types import Trajectories, SegmentStats, \
    RigidBodyDefinitions
from skellyblender.core.pure_python.rigid_bodies.calculate_segment_lengths import calculate_segment_length_stats, \
...
if __name__ == "__main__":
    from skellyblender.core.pure_python.freemocap_data.freemocap_recording_data import load_freemocap_test_recording
